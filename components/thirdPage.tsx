      ...
      <main className="flex-1 w-full max-w-7xl px-4">
        ...
        >
          ...
          <div className="flex flex-col items-center justify-between h-[600px]">
            {/* Top-left (cyan) */}
            <div
              className="w-[280px] h-40 rounded-3xl shadow-xl p-6 flex flex-col justify-evenly transform transition-transform duration-300 hover:scale-105"
              style={{
            ...
            <div
              className="w-[280px] mb-8 h-40 rounded-3xl shadow-xl p-6 flex flex-col justify-evenly transform transition-transform duration-300 hover:scale-105"
              style={{
          ...
          <div className="flex flex-col items-center justify-between h-[600px]">
            ...
            <div
              className="w-[280px] h-40 mb-8 rounded-3xl shadow-xl p-6 flex flex-col justify-evenly transform transition-transform duration-300 hover:scale-105"
              style={{
